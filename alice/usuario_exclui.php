    ...
    <body>
        ...
        <div class="content">
            ...
            <div id="login">
                ...
                <h2  class="usuario">EXCLUIR CONTAS</h2> 
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><label class="dados">EXCLUIR</label></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                ...
                                if ($qtde > 0){
                                    for ($cont=0; $cont <$qtde; $cont++){
                                        ...
                                        <?php
                                        echo "<td><label><a href='exclui.php?invNome=$linha[1]'>" ?> <img style="width: 30px;" src="imagens/excluir.png" alt="Alterar"></a></label></td>
                                        </tr>
                                        <?php
