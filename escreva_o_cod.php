   ...
   <style>
    ...
    <font size="2">
       <div class="login_content">
         ...
         <label>Um código foi enviado em seu email, digite-o abaixo para recuperar a senha.</label>
             <form action= "verificacao_cod.php" method="post">
                <div class="login">
                    <input class="imp_cadastro" type="number" name="codigo" max= '9999' min= '1000' placeholder=" " required>
                    <label>Código</label>
                    <span class="focus-border"></span>
                </div>
                <div>
                   <center>
                       <input class="btn_submit" type="submit" value="Continuar">
                   </center>
                </div>
            </form>
        </div>
