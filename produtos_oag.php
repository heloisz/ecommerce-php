...
Adaptado por Luís Fernando de Oliveira para projeto de ecommerce Styl 
    ...
    16/09/2020 - 18h49min
    22/09/2020 - 15h53min
    29/09/2020 - 12h28min - Heloísa
    29/09/2020 - 15h23min - Luís
*/
?>
...
<body>
    ...
    <div class="produto_container" align=center>
        <?php
            ...
            $sql = "SELECT * FROM produto WHERE excluido = 'n' ORDER BY nome ASC limit $limite offset $inicio";
                    ...
                    <div class="prod_over">
                        <div class="produto">
                           <?php
                            ...
                            /*------------ NOME --------------*/
                            echo "<label class='nome_prod'>".$linha['nome']."</label>";
                            /*------------ TAMANHO --------------*/
                            if(!is_null($linha['tamanho']) && $linha['tamanho'] != 'U')
                            {
                                echo "<label class='nome_prod'>Tamanho: ".$linha['tamanho']."</label>";
                            }
                            else if(!is_null($linha['tamanho']) && $linha['tamanho'] == 'U')
                                echo "<label class='nome_prod'>Tamanho: Único"."</label>";
                            /*------------ QUANTIDADE ESTOQUE --------------*/
                            ...
                            <div class="overlay_prod">
                                <a class="det_prop" href="">
                                    <div class="det_prod">Detalhes</div>
                                </a>
                                <?php
                                /*------------ BOTÃO COMPRAR --------------*/
                                if($linha['qtd_estoque']>0)
    ...
    <!------------------ FIM DA LISTAGEM PRODUTOS -----------------------------> 
               ...
               <footer id="footer"> <!--------- RODAPÉ - início ---------->
                   <br>
                    ...
                    <a class="links_header" href="developers.html">DEVELOPERS</a>
                    <br><br><br>
